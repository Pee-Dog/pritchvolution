...
public class pritchanimal<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head_r1 = left_coldhorn.addOrReplaceChild("head_r1", CubeListBuilder.create().texOffs(25, 0).addBox(-1.0F, -1.0F, 0.0F, 6.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 1.5708F, 0.0F));
		...
		PartDefinition head_r2 = right_coldhorn.addOrReplaceChild("head_r2", CubeListBuilder.create().texOffs(25, 0).addBox(0.0F, -4.0F, -1.0F, 6.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.0F, 3.0F, 1.0F, 0.0F, 1.5708F, 0.0F));
		...
		.texOffs(32, 0).addBox(2.0F, -3.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(4.0F, -7.0F, -2.0F));
		...
		.texOffs(32, 0).mirror().addBox(-4.0F, -3.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-4.0F, -7.0F, -2.0F));
		...
		PartDefinition right_ear = head_offset.addOrReplaceChild("right_ear", CubeListBuilder.create().texOffs(32, 8).mirror().addBox(-4.0F, -4.0F, -0.5F, 5.0F, 5.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-4.0F, -7.0F, 0.5F, 0.1309F, 0.0F, 0.0F));
		...
		PartDefinition right_bunnyear = head_offset.addOrReplaceChild("right_bunnyear", CubeListBuilder.create().texOffs(0, 32).mirror().addBox(-1.5F, -9.0F, -0.5F, 3.0F, 9.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(2.5F, -8.0F, 0.5F));

		PartDefinition snout = head_offset.addOrReplaceChild("snout", CubeListBuilder.create().texOffs(45, 0).mirror().addBox(-2.0F, -0.5F, -2.0F, 4.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(0.0F, -2.5F, -4.0F));

		PartDefinition beak = head_offset.addOrReplaceChild("beak", CubeListBuilder.create().texOffs(32, 4).mirror().addBox(-2.0F, -1.0F, -2.0F, 4.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(0.0F, -2.0F, -4.0F));

		PartDefinition nose = head_offset.addOrReplaceChild("nose", CubeListBuilder.create().texOffs(44, 5).mirror().addBox(-1.0F, -1.0F, -1.5F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(0.0F, -2.0F, -4.5F));

		PartDefinition left_flopear = head_offset.addOrReplaceChild("left_flopear", CubeListBuilder.create().texOffs(32, 8).addBox(0.0F, -2.5F, 0.0F, 5.0F, 5.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.0F, -7.0F, 0.0F, 1.5708F, 0.0F, 0.0F));

		PartDefinition right_flopear = head_offset.addOrReplaceChild("right_flopear", CubeListBuilder.create().texOffs(32, 8).mirror().addBox(-5.0F, -2.5F, 0.0F, 5.0F, 5.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-4.0F, -7.0F, 0.0F, 1.5708F, 0.0F, 0.0F));
		...
		PartDefinition left_leg_r1 = tail.addOrReplaceChild("left_leg_r1", CubeListBuilder.create().texOffs(8, 32).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 8.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 1.5708F, 0.0F, 0.0F));
		...
		PartDefinition left_leg_r2 = dolphintail.addOrReplaceChild("left_leg_r2", CubeListBuilder.create().texOffs(6, 32).addBox(-2.0F, 3.0F, 0.0F, 1.0F, 6.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.5F, 5.0F, 2.0F, 1.5708F, 0.0F, 0.0F));

		PartDefinition left_leg_r3 = dolphintail.addOrReplaceChild("left_leg_r3", CubeListBuilder.create().texOffs(28, 35).addBox(-2.75F, -3.0F, -2.0F, 5.0F, 9.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 3.0F, 1.5708F, 0.0F, -1.5708F));
