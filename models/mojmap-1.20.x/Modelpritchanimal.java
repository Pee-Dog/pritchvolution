...
public class Modelpritchanimal<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition nose = head_offset.addOrReplaceChild("nose", CubeListBuilder.create().texOffs(44, 5).addBox(
				-1.0F, -1.0F, -2.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -2.0F, -4.0F));

		PartDefinition snout = head_offset.addOrReplaceChild("snout", CubeListBuilder.create().texOffs(45, 0).addBox(
				-2.0F, -0.5F, -2.0F, 4.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -2.5F, -4.0F));

		PartDefinition beak = head_offset.addOrReplaceChild("beak", CubeListBuilder.create().texOffs(32, 4).addBox(
				-2.0F, -0.5F, -2.0F, 4.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -2.5F, -4.0F));

		PartDefinition right_ear = head_offset.addOrReplaceChild("right_ear", CubeListBuilder.create().texOffs(32, 8)
				.addBox(-3.0F, -4.0F, 0.0F, 5.0F, 5.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-4.0F, -7.0F, 0.0F));

		PartDefinition left_ear = head_offset.addOrReplaceChild("left_ear",
				CubeListBuilder.create().texOffs(32, 8).mirror()
						.addBox(-2.0F, -4.0F, 0.0F, 5.0F, 5.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offset(4.0F, -7.0F, 0.0F));

		PartDefinition left_flopear = head_offset.addOrReplaceChild("left_flopear", CubeListBuilder.create(),
				PartPose.offset(4.0F, -6.0F, 0.5F));

		PartDefinition head_r1 = left_flopear.addOrReplaceChild("head_r1",
				CubeListBuilder.create().texOffs(32, 8).addBox(-2.5F, -4.0F, -0.5F, 5.0F, 5.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -0.5F, 0.0F, 0.0F, -1.5708F, 1.5708F));

		PartDefinition right_flopear = head_offset.addOrReplaceChild("right_flopear", CubeListBuilder.create(),
				PartPose.offset(-4.0F, -6.0F, 0.5F));

		PartDefinition head_r2 = right_flopear.addOrReplaceChild("head_r2",
				CubeListBuilder.create().texOffs(32, 8).addBox(-2.5F, 7.0F, -0.5F, 5.0F, 5.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(8.0F, -0.5F, 0.0F, 0.0F, -1.5708F, 1.5708F));

		PartDefinition left_bunnyear = head_offset.addOrReplaceChild("left_bunnyear",
		...
		PartDefinition left_cowhorn = head_offset.addOrReplaceChild("left_cowhorn", CubeListBuilder.create()
				...
				PartPose.offset(4.0F, -7.0F, -1.5F));
		...
		PartDefinition left_warmhorn = head_offset.addOrReplaceChild("left_warmhorn",
				CubeListBuilder.create().texOffs(29, 0)
						.addBox(0.0F, -1.0F, -1.0F, 4.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(33, 0)
		...
		PartDefinition head_r3 = left_coldhorn
				.addOrReplaceChild("head_r3",
						CubeListBuilder.create().texOffs(24, 0).addBox(0.0F, -1.0F, -1.0F, 6.0F, 2.0F, 2.0F,
								new CubeDeformation(0.0F)),
		...
		PartDefinition head_r4 = right_coldhorn
		...
		PartDefinition tail_r1 = tail
				.addOrReplaceChild("tail_r1",
						CubeListBuilder.create().texOffs(8, 32).addBox(-1.0F, -0.7071F, -0.7071F, 2.0F, 8.0F, 2.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 1.5708F, 0.0F, 0.0F));

		PartDefinition fishtail = root_bone.addOrReplaceChild("fishtail", CubeListBuilder.create(),
				PartPose.offset(0.0F, -13.0F, 2.0F));

		PartDefinition tail_r2 = fishtail.addOrReplaceChild("tail_r2",
				CubeListBuilder.create().texOffs(0, 52).addBox(-4.0F, -0.4571F, 0.0429F, 7.0F, 12.0F, 0.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition tail_r3 = dolphintail.addOrReplaceChild("tail_r3",
				CubeListBuilder.create().texOffs(6, 32).addBox(-1.0F, 2.5429F, -3.9571F, 1.0F, 6.0F, 10.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.0F, 0.5F, 3.0F, 1.5708F, 0.0F, 1.5708F));

		PartDefinition tail_r4 = dolphintail.addOrReplaceChild("tail_r4",
				CubeListBuilder.create().texOffs(28, 35).addBox(-2.0F, -0.4571F, -1.9571F, 5.0F, 9.0F, 4.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -0.5F, 0.0F, 1.5708F, 0.0F, 1.5708F));

		PartDefinition right_leg = root_bone.addOrReplaceChild("right_leg",
