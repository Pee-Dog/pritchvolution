...
public class Modelpritchanimal<T extends Entity> extends EntityModel<T> {
	...
	private final ModelPart left_frontleg_offset;
	private final ModelPart right_frontleg;
	private final ModelPart right_frontleg_offset;
	private final ModelPart left_leg;
	private final ModelPart right_leg;
	private final ModelPart left_cleg1;
	private final ModelPart right_cleg1;
	private final ModelPart left_cleg2;
	private final ModelPart right_cleg2;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition snout = head_offset.addOrReplaceChild("snout",
				CubeListBuilder.create().texOffs(45, 0).mirror()
						.addBox(-2.0F, -1.0F, -2.0F, 4.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offset(0.0F, -2.0F, -4.0F));

		PartDefinition nose = head_offset.addOrReplaceChild("nose",
				CubeListBuilder.create().texOffs(44, 5).mirror()
						.addBox(-1.0F, -1.0F, -2.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offset(0.0F, -2.0F, -4.0F));

		PartDefinition beak = nose.addOrReplaceChild("beak",
				CubeListBuilder.create().texOffs(32, 4).mirror()
						.addBox(-4.0F, -2.0F, -1.5F, 4.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
		...
		PartDefinition left_frontleg = root_bone.addOrReplaceChild("left_frontleg", CubeListBuilder.create(),
				PartPose.offsetAndRotation(2.0F, -22.0F, 0.0F, -1.5708F, 0.0F, 0.0F));

		PartDefinition left_frontleg_offset = left_frontleg.addOrReplaceChild("left_frontleg_offset", CubeListBuilder
				.create().texOffs(0, 16).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition right_frontleg = root_bone.addOrReplaceChild("right_frontleg", CubeListBuilder.create(),
				PartPose.offsetAndRotation(-2.0F, -22.0F, 0.0F, -1.5708F, 0.0F, 0.0F));

		PartDefinition right_frontleg_offset = right_frontleg.addOrReplaceChild("right_frontleg_offset", CubeListBuilder
				.create().texOffs(0, 16).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		PartDefinition left_cleg1 = root_bone.addOrReplaceChild("left_cleg1", CubeListBuilder.create().texOffs(0, 16)
				.addBox(-2.0F, 0.0F, -4.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(2.0F, -12.0F, -2.0F));

		PartDefinition right_cleg1 = root_bone.addOrReplaceChild("right_cleg1", CubeListBuilder.create().texOffs(0, 16)
				.addBox(-2.0F, 0.0F, -4.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-2.0F, -12.0F, -2.0F));

		PartDefinition left_cleg2 = root_bone.addOrReplaceChild("left_cleg2", CubeListBuilder.create().texOffs(0, 16)
				.addBox(-2.0F, 0.0F, 0.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(2.0F, -12.0F, 2.0F));

		PartDefinition right_cleg2 = root_bone.addOrReplaceChild("right_cleg2", CubeListBuilder.create().texOffs(0, 16)
				.addBox(-2.0F, 0.0F, 0.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-2.0F, -12.0F, 2.0F));
		...
		PartDefinition left_leg_r3 = dolphintail.addOrReplaceChild("left_leg_r3",
				CubeListBuilder.create().texOffs(28, 32).addBox(-2.75F, -3.0F, -2.0F, 5.0F, 9.0F, 4.0F,
						new CubeDeformation(0.0F)),
