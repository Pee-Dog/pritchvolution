...
public class HumanPritchanimalGeneratorOnInitialEntitySpawnProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		HumanPritchanimalSetup1Procedure.execute(pritchanimal);
		HumanPritchanimalSetup2Procedure.execute(pritchanimal);
