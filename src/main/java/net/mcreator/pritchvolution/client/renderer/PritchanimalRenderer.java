				...
				AnimationDefinition armslegstest = AnimationDefinition.Builder.withLength(0.0F).looping()
						.addAnimation("neck",
								new AnimationChannel(AnimationChannel.Targets.ROTATION, 
										new Keyframe(0.0F, 
												KeyframeAnimations.degreeVec((float) entity.getEntityData().get(PritchanimalEntity.DATA_ROTATION_Neck_x), 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR)))
						.addAnimation("body",
								new AnimationChannel(AnimationChannel.Targets.ROTATION, 
										new Keyframe(0.0F, 
						...
						.addAnimation("left_flopear",
								new AnimationChannel(AnimationChannel.Targets.ROTATION, 
										new Keyframe(0.0F, 
												KeyframeAnimations.degreeVec(0.0F, 0.0F, (float) entity.getEntityData().get(PritchanimalEntity.DATA_ROTATION_Flopear_z)), AnimationChannel.Interpolations.LINEAR)))
						...
						.addAnimation("snout",
								new AnimationChannel(AnimationChannel.Targets.ROTATION, 
										new Keyframe(0.0F, 
												KeyframeAnimations.degreeVec((float) entity.getEntityData().get(PritchanimalEntity.DATA_ROTATION_Snout_x), 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR)))
								...
								new AnimationChannel(AnimationChannel.Targets.SCALE, 
										new Keyframe(0.0F, 
												KeyframeAnimations.scaleVec((float) entity.getEntityData().get(PritchanimalEntity.DATA_SCALE_Tail_x) / 100, (float) entity.getEntityData().get(PritchanimalEntity.DATA_SCALE_Tail_y) / 100, 
														(float) entity.getEntityData().get(PritchanimalEntity.DATA_SCALE_Tail_z) / 100), AnimationChannel.Interpolations.LINEAR)))
								...
								new AnimationChannel(AnimationChannel.Targets.SCALE, 
										new Keyframe(0.0F, 
												KeyframeAnimations.scaleVec((float) entity.getEntityData().get(PritchanimalEntity.DATA_SCALE_Dolphintail_x) / 100, (float) entity.getEntityData().get(PritchanimalEntity.DATA_SCALE_Dolphintail_y) / 100, 
														(float) entity.getEntityData().get(PritchanimalEntity.DATA_SCALE_Dolphintail_z) / 100), AnimationChannel.Interpolations.LINEAR)))
						.addAnimation("fishtail", 
								new AnimationChannel(AnimationChannel.Targets.SCALE, 
										new Keyframe(0.0F, 
												KeyframeAnimations.scaleVec(0.0F, (float) entity.getEntityData().get(PritchanimalEntity.DATA_SCALE_Fishtail_y) / 100, 
														(float) entity.getEntityData().get(PritchanimalEntity.DATA_SCALE_Fishtail_z) / 100), AnimationChannel.Interpolations.LINEAR)))
								...
								new AnimationChannel(AnimationChannel.Targets.SCALE, 
										new Keyframe(0.0F, 
												KeyframeAnimations.scaleVec((float) entity.getEntityData().get(PritchanimalEntity.DATA_SCALE_Head_x) / 100, (float) entity.getEntityData().get(PritchanimalEntity.DATA_SCALE_Head_y) / 100, 
														(float) entity.getEntityData().get(PritchanimalEntity.DATA_SCALE_Head_z) / 100), AnimationChannel.Interpolations.LINEAR)))
						.addAnimation("neck", 
								new AnimationChannel(AnimationChannel.Targets.SCALE, 
										new Keyframe(0.0F, 
												KeyframeAnimations.scaleVec((float) entity.getEntityData().get(PritchanimalEntity.DATA_SCALE_Neck_x) / 100, (float) entity.getEntityData().get(PritchanimalEntity.DATA_SCALE_Neck_y) / 100, 
														(float) entity.getEntityData().get(PritchanimalEntity.DATA_SCALE_Neck_z) / 100), AnimationChannel.Interpolations.LINEAR)))
						.addAnimation("nose", 
								new AnimationChannel(AnimationChannel.Targets.SCALE, 
										new Keyframe(0.0F, 
								...
								new AnimationChannel(AnimationChannel.Targets.SCALE, 
										new Keyframe(0.0F, 
												KeyframeAnimations.scaleVec((float) entity.getEntityData().get(PritchanimalEntity.DATA_SCALE_Ear_x) / 100, (float) entity.getEntityData().get(PritchanimalEntity.DATA_SCALE_Ear_y) / 100, 
														(float) entity.getEntityData().get(PritchanimalEntity.DATA_SCALE_Ear_z) / 100), AnimationChannel.Interpolations.LINEAR)))
								...
								new AnimationChannel(AnimationChannel.Targets.SCALE, 
										new Keyframe(0.0F, 
												KeyframeAnimations.scaleVec((float) entity.getEntityData().get(PritchanimalEntity.DATA_SCALE_Cowhorn_x) / 100, (float) entity.getEntityData().get(PritchanimalEntity.DATA_SCALE_Cowhorn_y) / 100, 
														(float) entity.getEntityData().get(PritchanimalEntity.DATA_SCALE_Cowhorn_z) / 100), AnimationChannel.Interpolations.LINEAR)))
								...
								new AnimationChannel(AnimationChannel.Targets.SCALE, 
										new Keyframe(0.0F, 
												KeyframeAnimations.scaleVec((float) entity.getEntityData().get(PritchanimalEntity.DATA_SCALE_Warmhorn_x) / 100, (float) entity.getEntityData().get(PritchanimalEntity.DATA_SCALE_Warmhorn_y) / 100, 
														(float) entity.getEntityData().get(PritchanimalEntity.DATA_SCALE_Warmhorn_z) / 100), AnimationChannel.Interpolations.LINEAR)))
								...
								new AnimationChannel(AnimationChannel.Targets.SCALE, 
										new Keyframe(0.0F, 
												KeyframeAnimations.scaleVec((float) entity.getEntityData().get(PritchanimalEntity.DATA_SCALE_Coldhorn_x) / 100, (float) entity.getEntityData().get(PritchanimalEntity.DATA_SCALE_Coldhorn_y) / 100, 
														(float) entity.getEntityData().get(PritchanimalEntity.DATA_SCALE_Coldhorn_z) / 100), AnimationChannel.Interpolations.LINEAR)))
						...
						.addAnimation("left_flopear", 
								new AnimationChannel(AnimationChannel.Targets.SCALE, 
										new Keyframe(0.0F, 
												KeyframeAnimations.scaleVec((float) entity.getEntityData().get(PritchanimalEntity.DATA_SCALE_Flopear_x) / 100, 1.0F, 
														(float) entity.getEntityData().get(PritchanimalEntity.DATA_SCALE_Flopear_z) / 100), AnimationChannel.Interpolations.LINEAR)))
						.addAnimation("right_flopear", 
								new AnimationChannel(AnimationChannel.Targets.SCALE, 
										new Keyframe(0.0F, 
												KeyframeAnimations.scaleVec((float) entity.getEntityData().get(PritchanimalEntity.DATA_SCALE_Flopear_x) / 100, 1.0F, 
								...
								new AnimationChannel(AnimationChannel.Targets.SCALE, 
										new Keyframe(0.0F, 
												KeyframeAnimations.scaleVec((float) entity.getEntityData().get(PritchanimalEntity.DATA_SCALE_Bunnyear_x) / 100, (float) entity.getEntityData().get(PritchanimalEntity.DATA_SCALE_Bunnyear_y) / 100, 
														(float) entity.getEntityData().get(PritchanimalEntity.DATA_SCALE_Bunnyear_z) / 100), AnimationChannel.Interpolations.LINEAR)))
						...
						.addAnimation("head", 
								new AnimationChannel(AnimationChannel.Targets.POSITION, 
										new Keyframe(0.0F, 
												KeyframeAnimations.posVec(0.0F, (float) entity.getEntityData().get(PritchanimalEntity.DATA_POSITION_Head_y), 
														(float) entity.getEntityData().get(PritchanimalEntity.DATA_POSITION_Head_z)), AnimationChannel.Interpolations.LINEAR)))
						.addAnimation("head_offset", 
								new AnimationChannel(AnimationChannel.Targets.POSITION, 
										new Keyframe(0.0F, 
												KeyframeAnimations.posVec(0.0F, (float) entity.getEntityData().get(PritchanimalEntity.DATA_POSITION_HeadOffset_y), 
														(float) entity.getEntityData().get(PritchanimalEntity.DATA_POSITION_HeadOffset_z)), AnimationChannel.Interpolations.LINEAR)))
						.addAnimation("left_ear", 
								new AnimationChannel(AnimationChannel.Targets.POSITION, 
										new Keyframe(0.0F, 
												KeyframeAnimations.posVec(0.0F, (float) entity.getEntityData().get(PritchanimalEntity.DATA_POSITION_Ear_y), 0.0F), AnimationChannel.Interpolations.LINEAR)))
						.addAnimation("right_ear", 
								new AnimationChannel(AnimationChannel.Targets.POSITION, 
										new Keyframe(0.0F, 
												KeyframeAnimations.posVec(0.0F, (float) entity.getEntityData().get(PritchanimalEntity.DATA_POSITION_Ear_y), 0.0F), AnimationChannel.Interpolations.LINEAR)))
