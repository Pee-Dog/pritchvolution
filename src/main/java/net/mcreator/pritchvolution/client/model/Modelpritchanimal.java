...
public class Modelpritchanimal<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition left_leg_r3 = dolphintail.addOrReplaceChild("left_leg_r3", CubeListBuilder.create().texOffs(28, 35).addBox(-2.75F, -3.0F, -2.0F, 5.0F, 9.0F, 4.0F, new CubeDeformation(0.0F)),
