...
import net.mcreator.pritchvolution.procedures.RandomPritchanimalGeneratorOnInitialEntitySpawnProcedure;
...
public class RandomPritchanimalGeneratorEntity extends Monster {
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(PritchvolutionModEntities.RANDOM_PRITCHANIMAL_GENERATOR.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
